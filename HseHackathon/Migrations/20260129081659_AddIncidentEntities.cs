    ...
    public partial class AddIncidentEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "A near miss incident that could have resulted in injury or damage", "Near Miss" },
                    { 2, "An actual injury incident", "Injury" },
                    { 3, "Environmental hazard or spillage", "Environmental" },
                    { 4, "Damage to property or equipment", "Property Damage" },
                    { 5, "Other HSE-related incidents", "Other" }
                });
